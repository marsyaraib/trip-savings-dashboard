      ...
      <header className="sticky top-0 z-40 hidden border-b border-slate-200/70 bg-white/80 backdrop-blur-md dark:border-slate-800/70 dark:bg-slate-950/80 md:block">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <Link href="/" className="flex items-center gap-2 font-semibold text-slate-900 dark:text-slate-50">
            <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-lacquer-500 to-lacquer-700 text-white">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-lacquer-50 text-lacquer-700 dark:bg-lacquer-500/10 dark:text-lacquer-400"
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "text-lacquer-600 dark:text-lacquer-400" : "text-slate-500 dark:text-slate-400"
              )}
            >
